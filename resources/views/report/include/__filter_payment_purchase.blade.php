        ...
        <form action="{{ request()->url() }}" method="get">
            <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="js-example-basic-single" name="account" id="account">
                            ...
                            @foreach($accounts as $key => $value)
                                <option value="{{ $value->id }}" @selected(request('account') == $value->id)>{{ $value->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-4 mt-4">
                    ...
                    <a href="{{ route('report.payment.purchase') }}" class="btn btn-danger label-btn mt-2 w-40">
