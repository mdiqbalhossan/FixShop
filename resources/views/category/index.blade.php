...
@section('hidden_input')
    <input type="hidden" name="edit_text" id="edit_text" value="{{ __('Edit Category') }}">
    <input type="hidden" name="update_route" id="update_route" value="{{ route('category.update', ':id') }}">
    <input type="hidden" name="delete_route" id="delete_route" value="{{ route('category.destroy', ':id') }}">
