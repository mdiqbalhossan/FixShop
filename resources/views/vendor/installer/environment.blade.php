...
@section('style')
    ...
    {{-- This is Installer Package CSS. That's Why I cannot move internal css to external css file --}}
    <style>
        .form-control{
            height: 14px;
            width: 100%;
...
@section('container')
    ...
    {{-- This is Installer Package JS. That's Why I cannot move internal js to external js file --}}
    <script>
        function checkEnv() {
            $.easyAjax({
